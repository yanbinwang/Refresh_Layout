package com.shuniuyun.refresh.widget.xrecyclerview;
...
import com.shuniuyun.refresh.widget.empty.EmptyLayout;
import com.shuniuyun.refresh.widget.xrecyclerview.callback.OnEmptyClickListener;
import com.shuniuyun.refresh.widget.xrecyclerview.callback.OnRefreshListener;
...
public class XRecyclerView extends ViewGroup {
    ...
    private XRefreshLayout swipeRefreshLayout;//刷新控件 类型1才有
    ...
    private void initType(int recType) {
        ...
        switch (recType) {
            ...
            case 1:
                ...
                detectionRecyclerView = view.findViewById(R.id.m_rec);
                swipeRefreshLayout.setDirection(refreshDirection);
                detectionRecyclerView.setHasFixedSize(true);
                detectionRecyclerView.setItemAnimator(new DefaultItemAnimator());
                if (0 != containerType) {
                    emptyLayout.setOnEmptyRefreshListener(() -> {
    ...
    public void addItemDecoration(int horizontalSpace, int verticalSpace, boolean hasHorizontalEdge, boolean hasVerticalEdge) {
        ...
        SCommonItemDecoration.ItemDecorationProps prop1 = new SCommonItemDecoration.ItemDecorationProps(DisplayUtil.dip2px(context, horizontalSpace), DisplayUtil.dip2px(context, verticalSpace), hasHorizontalEdge, hasVerticalEdge);
        propMap.put(0, prop1);
